...
And you can, of course, implement any feature you'd like. Also, `Webshell`
component forwards refs to inner `WebView`, so **you can still use ref instance
methods with no code change.**
