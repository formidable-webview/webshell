...
2. `context.postShellMessage` will send an event which will be intercepted by the shell. If an event handler has been registered for this feature and passed as a prop to the shell, it will be invoked with the message content.
...
| Symbol                            | Description                                                                                                       |
| :-------------------------------- | :---------------------------------------------------------------------------------------------------------------- |
| `linkPressScript`                 | Behavior in the Web environment.                                                                                  |
| `defaultOptions`                  | Default options for this feature.                                                                                 |
| `"onDOMLinkPress"`                | The name of the handler prop which will be available in the shell.                                                |
